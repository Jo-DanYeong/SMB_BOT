...
└── web/────────────────────────> 웹 인터페이스
    ├── api/────────────────────> REST API
    │   ├── CurseWordApiController.java
    │   ├── WarnApiController.java
    │   ├── GuildPermissionApiController.java
    │   └── GuildUserApiController.java
    ├── auth/───────────────────> 인증
    │   ├── AuthController.java
    │   ├── AdminAuthFilter.java
    │   └── AdminSession.java
    ├── discord/────────────────> 디스코드 연동
    │   ├── DiscordPermissionService.java
    │   └── DiscordUserService.java
    └── dto/────────────────────> 데이터 전송 객체
        ├── AuthStatus.java
        ├── LoginRequest.java
        ├── CurseWordResponse.java
        └── ...
```
